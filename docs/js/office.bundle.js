/*! For license information please see office.bundle.js.LICENSE.txt */
!(function () {
  var e = {
      741: function (e, t, n) {
        var i, r;
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      Le(B);
      const $ = document.querySelectorAll(".buildings__element"),
        F = document.querySelector(".control-quantity-btn--plus"),
        G = document.querySelector(".control-quantity-btn--minus"),
        Y = document.querySelectorAll(".service-element .checkbox"),
        U = document.querySelector(".table__data"),
        X = document.querySelector("#take-keys-btn"),
        V = document.querySelector("#give-keys-btn"),
        Q = document.querySelector(".keys-address-block"),
        K = document.querySelector(".keys-address-block__take-item"),
        J = document.querySelector(".keys-address-block__give-item");
      F?.addEventListener("click", ie),
        G?.addEventListener("click", ie),
        X?.addEventListener("click", de),
          ...
          e.addEventListener("change", (e) => {
            !(function (e) {
              ...
              const o = (function (e) {
                  ...
                  const o = ce("item__name", `${t}`),
                    a = ce("", "x"),
                    s = ce("name-wrapper"),
                    c = ce("quantity-wrapper");
                  ue(c, [
                    a,
                    ce("item__quantity service-quantity", Z[i].quantity),
                  ]),
                    ue(s, [o, c]);
                  const u = ce("service-value", `${n}zł`);
                  return u.setAttribute("data-service", i), ue(r, [s, u]), r;
                })(n),
                a = n.getAttribute("data-id");
              (function (e, t) {
                const n = t.id,
                  i = (function (e) {
                    return [...U.querySelectorAll("li")].find(
                      (t) => t.id === e
                    );
                  })(n);
                e && !i
                  ? ((function (e) {
                      U.insertAdjacentElement("beforeend", e);
                    })(t),
                    ae(n))
                  : !e &&
                    i &&
      ...
      function te(e) {
        ...
        !(function (e, t) {
          if ("plus" === t) Z[e].quantity += 1;
          else if ("minus" === t) {
            if (1 === Z[e].quantity) return;
            Z[e].quantity -= 1;
          }
        })(t, n),
          (function (e) {
            ...
            n && (n.textContent = Z[e].quantity),
              i &&
                ((i.textContent = Z[e].quantity),
      ...
      function ie(e) {
        te(e),
          (function () {
            ...
            (ee.square.quantity = Z.square.quantity),
              (e.textContent = ee.square.quantity * ee.square.price + "zł");
          })(),
          se(ee);
      }
      function re(e) {
      ...
      function ae(e, t) {
        const n = void 0 !== t ? t : Z[e].quantity;
        return (ee[e].quantity = n), n;
      }
      function se(e) {
        const t =
          ((n = e),
      ...
      function de(e) {
        ...
        t.classList.toggle("active"),
          "take-keys-btn" === t.id
            ? K.classList.toggle("isHidden")
            : J.classList.toggle("isHidden"),
          (function () {
            const e = K.classList.contains("isHidden"),
              t = J.classList.contains("isHidden");
            e && t
              ? Q.classList.add("isHidden")
              : Q.classList.remove("isHidden");
          })();
      }
      const fe = document.querySelector(".subscr__form"),
        pe = document.querySelectorAll(".payment__btn"),
        he = document.querySelector(".form__payment-error-text"),
        me = document.querySelectorAll(".form__input"),
        ge = document.querySelector(".calc-btn"),
        ye = document.querySelector('[name="studio-policy-check"]');
      let ve;
      ye &&
        ((ve = new MutationObserver((e, t) => {
          e.forEach((e) => {
            "attributes" === e.type &&
              "data-checked" === e.attributeName &&
              (ye.getAttribute("data-checked"), _e());
          });
        })),
        ve.observe(ye, { attributes: !0, attributeFilter: ["data-checked"] }),
        ye.addEventListener("change", () => {
          ye.setAttribute("data-checked", ye.checked);
        })),
        fe?.addEventListener("submit", ke),
      ...
      function Ce() {
        !he.classList.contains("isHidden") && Te();
      }
      function _e() {
        document
      ...
      function ke(t) {
        ...
        const n = "BUTTON" === t.currentTarget.tagName,
          i = n ? fe.elements : t.currentTarget.elements,
          r = (function (e, t) {
        ...
        const o = [...pe].some((e) => e.classList.contains("active")),
          a = r.length > 0;
        o || Te(),
          (function () {
            const e = document.querySelector(".form__policy-error-text");
            e.classList.add("isHidden"), Ee() || e.classList.remove("isHidden");
          })();
        const s = Ee();
        if (!o || a || !s) return;
        const c = n ? fe : t.target;
        var u, l, d;
        n &&
          ((function () {
            const e = document.querySelector(
          ...
          (u = xe),
          (l = ee.square.quantity),
          (d = ee.square.price),
          (u.userSquare = { quantity: `${l}`, cost: oe(l, d) }),
          (function (e) {
            const t =
              ((n = ee),
              Object.keys(n)
            ...
            e.userServices = Object.keys(t)
              ...
              .map((e) => {
                ...
                return { name: n, quantity: i, cost: oe(i, r) };
              });
          })(xe)),
          (function (e) {
            new FormData(e).forEach((e, t) => {
              t.startsWith("user") && (xe[t] = e);
            });
          })(c),
          e("userOrderDataObj", xe),
          (function (e) {
            [...e].forEach((e) => {
              "text" === e.type ||
              "email" === e.type ||
        ...
        document.querySelectorAll(".calendar").forEach(function (e) {
          ...
          function y(e, t) {
            ...
            if ("previous-month" === t) {
              ...
              const { formattedDay: t } = je(e);
              o = new Date(n, i, t);
            } else if ("next-month" === t) {
              const { formattedDay: t } = je(e, i, n);
